...
internal fun MainDialogs(
    ...
    if (alert.needsGpsDialog) {
        AlertNeedsGpsDialog(
            // Droit aux reglages du systeme : cette boite ne parait que la localisation du telephone
            // eteinte. Au retour, le capteur relu allume le suivi mis en attente (cf. awaitGps).
