...
object Providers {
    fun defaults(): List<ProviderEntity> {
        ...
        return listOf(
            ...
            ProviderEntity("se", "Suède - Lantmäteriet", "Pays", "WMTS",
            ...
            ProviderEntity("hr", "Croatie - DGU", "Pays", "WMS",
                ...
                maxZoom = 18, enabled = false, sortOrder = n()),
            ProviderEntity("ch", "Swiss Topo", "Pays", "WMTS",
            ...
            ProviderEntity("de", "Allemagne - Web Raster", "Pays", "WMTS",
            ...
            ProviderEntity("fi", "Finlande - Maastokartta", "Pays", "WMTS",
            ...
            ProviderEntity("si", "Slovénie - GURS DTK50", "Pays", "WMS",
            ...
            ProviderEntity("cz", "Tchéquie - CUZK ZTM", "Pays", "XYZ",
            ...
            ProviderEntity("gb", "Royaume-Uni - OS Outdoor", "Pays", "XYZ",
            ...
            ProviderEntity("pl", "Pologne - GUGiK Topo", "Pays", "WMS",
            ...
            // minZoom 13 : en dessous le 25k est tasse et illisible. maxZoom 16 : au-dela c'est du flou.
            // Continent seulement, Madere et les Acores renvoient une image blanche.
            ProviderEntity("pt", "Portugal - Carta Militar 25k", "Pays", "WMS",
